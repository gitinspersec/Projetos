...
- Projetos individuais:
  - `submissions/Individual/<NomeDoAluno>/<NomeDoProjeto>/README.md`
- Projetos em grupo:
  - `submissions/Team/<NomeDaEquipe>/<NomeDoProjeto>/README.md`

### Exemplo

- `submissions/Individual/Murilo_Miacci/Hash_ID/README.md`
- `submissions/Team/FoxTeam/Hash_Cracker/README.md`
...
2. Adicione a pasta de entrega em `submissions/`.
